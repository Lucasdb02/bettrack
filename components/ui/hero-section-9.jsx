              ...
              <div className="bg-background group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent">
                ...
                <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit lg:border-l lg:pl-6">
                  ...
                  <Button asChild size="sm">
                    <Link href="/signup"><span>Aanmelden</span></Link>
                  </Button>
                </div>
              </div>
            </div>
            ...
            <div className="[perspective:1200px] [mask-image:linear-gradient(to_right,black_50%,transparent_100%)] -mr-16 pl-16 lg:-mr-56 lg:pl-56">
              <div className="[transform:rotateX(20deg)]">
                <div className="lg:h-[44rem] relative skew-x-[.36rad]">
                  <img
                    className="rounded-xl z-[2] relative border dark:hidden"
                    src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=2880&q=75"
                    alt="Dashboard analytics light"
                    width={2880}
                    height={2074}
                  />
                  <img
                    className="rounded-xl z-[2] relative hidden border dark:block"
                    src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=2880&q=75"
                    alt="Dashboard analytics dark"
                    width={2880}
                    height={2074}
                  />
                </div>
