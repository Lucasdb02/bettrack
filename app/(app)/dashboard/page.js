...
export default function Dashboard() {
  ...
  return (
    <div style={{ padding:'24px' }} className="app-page">
      ...
      <div style={{ display:'flex', alignItems:'stretch', gap:8, marginBottom:16, flexWrap:'wrap' }}>
                  ...
                  <ComposedChart data={chartData} margin={isMobile ? {top:5,right:0,left:0,bottom:0} : {top:5,right:10,left:0,bottom:0}} tabIndex={-1}
                    ...
                    <defs>
                      <linearGradient id="pg" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="0%"  stopColor="#5469d4" stopOpacity={0.15}/>
                        <stop offset="80%" stopColor="#5469d4" stopOpacity={0}/>
                      </linearGradient>
                    ...
                    <Area type={cardinalCurve} dataKey="pnl" name="P&L" stroke="#5469d4" strokeWidth={2} fill="url(#pg)" baseValue={0} dot={false} activeDot={{r:5,fill:'#5469d4',stroke:'#fff',strokeWidth:2}}/>
                    <Area type={cardinalCurve} dataKey="dayPnl" name="Dagelijks" stroke="#f59e0b" strokeWidth={1.5} fill="url(#og)" baseValue={0} dot={false} activeDot={{r:5,fill:'#f59e0b',stroke:'#fff',strokeWidth:2}}/>
