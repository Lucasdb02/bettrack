    ...
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: bg, padding: '24px 16px', transition: 'background 0.2s' }}>
        <div style={{ width: '100%', maxWidth: 380, textAlign: 'center' }}>
          <div style={{ width: 56, height: 56, borderRadius: '50%', background: 'rgba(84,105,212,0.12)', border: '1px solid rgba(84,105,212,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px' }}>
            <svg width="26" height="26" fill="none" viewBox="0 0 24 24" stroke="#5469d4" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7"/>
            </svg>
          </div>
          <h2 style={{ color: text1, fontSize: 20, fontWeight: 700, marginBottom: 8 }}>Bevestig je e-mail</h2>
          <p style={{ color: text3, fontSize: 14, lineHeight: 1.6 }}>
    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: bg, padding: '24px 16px', transition: 'background 0.2s' }}>
      <div style={{ width: '100%', maxWidth: 380 }}>
        ...
        <div style={{ marginBottom: 28, textAlign: 'center' }}>
          <h1 style={{ color: text1, fontSize: 24, fontWeight: 800, letterSpacing: '-0.025em', marginBottom: 6, lineHeight: 1.2 }}>Maak je gratis account aan</h1>
          <p style={{ color: text3, fontSize: 14 }}>Start vandaag nog. Geen creditcard nodig.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div>
            <label style={{ display: 'block', fontSize: 13, fontWeight: 500, color: text3, marginBottom: 6 }}>Wachtwoord</label>
            <input
          ...
          <div>
            <label style={{ display: 'block', fontSize: 13, fontWeight: 500, color: text3, marginBottom: 6 }}>Wachtwoord bevestigen</label>
            <input
              type="password" required autoComplete="new-password"
